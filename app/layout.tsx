...
export const metadata: Metadata = {
  ...
  title: {
    default: "Social Drive — AI-Powered Marketing for Small Businesses",
    template: "%s | Social Drive",
  },
  description:
    "Social Drive builds AI-powered marketing tools, strategies, and systems for small businesses in Greencastle, PA and beyond. Free tools, affordable reports, and managed marketing.",
  keywords: [
